  ...
  return (
    <div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 rounded-lg border border-black/10 bg-white px-4 py-3 text-[0.95rem] font-medium text-[#14181c] shadow-sm hover:bg-white/90 transition-colors"
      >
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="font-mono text-[11px] uppercase tracking-wider text-[#14181c]/40">
          or email
        </span>
        <span className="flex-1 h-px bg-black/10" />
      </div>
