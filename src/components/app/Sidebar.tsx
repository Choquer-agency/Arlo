    ...
    <aside className="w-64 shrink-0 flex flex-col">
      <div className="px-6 py-6 border-b border-dark/5">
        ...
        <a
          ...
          className="mt-4 flex items-center justify-center gap-2 bg-brand-lime text-dark px-3 py-2.5 rounded-lg font-mono text-xs uppercase tracking-wider hover:opacity-90 transition-opacity"
        >
